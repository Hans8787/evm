...
$edit = DB::q1("SELECT * FROM `event` WHERE id = $id");
...
<head>
  ...
  <title>GenMaung | Edit Events</title>
...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="../charts/morris.html"><i class="fa fa-circle-o"></i> Galery</a></li>
            <li><a href="../charts/chartjs.html"><i class="fa fa-circle-o"></i> Upload Foto & Video</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Edit Event
        <small>Jangan memberi berita Hoax  </small>
      </h1>
      <ol class="breadcrumb">
      ...
      <div class="box">
        <form action="edit_event.php" method="post" enctype="multipart/form-data">
          ...
          <div class="box-header with-border">
            <input type="text" class="form-control" name="judul" placeholder="Nama Kegiatan" style="border-radius: 5px; margin-bottom: 10px;" value="<?= $edit['judul']; ?>" required>
          </div>
          <div class="box-header with-border">
            <input type="text" class="form-control" name="tempat" placeholder="Tempat Kegiatan" style="border-radius: 5px;" value="<?= $edit['tempat']; ?>" required>
          </div>
          <!-- Date range -->
          <div class="form-group box-header with-border" style="padding: 10px;">
            <label for="datepicker">Waktu Pelaksanaan :</label>

            <div class="input-group date">
              <div class="input-group-addon" style="border-radius: 5px 0 0 5px;">
                <i class="fa fa-calendar"></i>
              </div>
              <input type="text" class="form-control pull-right" name="tanggal" id="datepicker" style="border-radius: 0 5px 5px 0;" value="<?= $edit['tanggal']; ?>" required>
            </div>
            <!-- /.input group -->
          </div>
          <!-- /.form group -->
          <div class="form-group box-header with-border">
            <img src="<?= $edit['cover']; ?>" style="width: 70px;">
            <input class="form-control" type="file" id="InputFile" name="file" style="border-radius: 5px;">
          </div>
          <!-- /.box-body -->
          <textarea class="form-control texteditor" name="isiEvent" id="isiEvent" cols="30" rows="10" required><?= $edit['content']; ?></textarea>
          <!-- /.textarea-->
