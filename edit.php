...
// ambil data info sekolah
$info = DB::q1("SELECT * FROM info");
...
<head>
  ...
  <title>GenMaung | Edit Info</title>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="edit.php"><i class="fa fa-circle-o"></i> Edit Info</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="visi_misi">
                <div class="form-group">
                  <label>Visi</label><br>
                  <textarea class="form-control" name="visi" rows="10"><?= $info["visi"]; ?></textarea>
                </div><br><br>
                <div class="form-group">
                  <label>Misi</label><br>
                  <textarea class="form-control" name="misi" rows="10"><?= $info["misi"]; ?></textarea>
                </div>
              </div>
              <!-- /.tab-pane -->
              <div class="tab-pane" id="sambutan">
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="sambutan" rows="10"><?= $info["sambutan"]; ?></textarea>
                </div>
              </div>
              <!-- /.tab-pane -->
              <div class="tab-pane" id="sejarah">
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="sejarah" rows="10"><?= $info["sejarah"]; ?></textarea>
                </div>
              </div>
              <!-- /.tab-pane -->
              <div class="tab-pane" id="struktur">
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="struktur" rows="10"><?= $info["struktur"]; ?></textarea>
                </div>
              </div>
              <!-- /.tab-pane -->
              <div class="tab-pane" id="alamat">
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="alamat" rows="10"><?= $info["alamat"]; ?></textarea>
                </div><br><br>
                <div class="form-group">
                  <label>Kontak</label><br>
                  <textarea class="form-control" name="kontak" rows="10"><?= $info["kontak"]; ?></textarea>
                </div>
              </div>
