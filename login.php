...
if ( isset($_POST["login"]) ) { 
  ...
  $_SESSION["login"] = true;
	...
	$user = Akun::login($_POST['username'], $_POST['password']);
	if ( $user === false ) { 
		echo '<div class="alert alert-danger mt-4 container" role="alert">
...
<div class="login-box">
  <div class="login-logo">
    <a href="login.php"><b>Gen</b>Maung</a>
  </div>
  <!-- /.login-logo -->
