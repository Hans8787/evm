...
<head>
  ...
  <title>GenMaung | Input Events</title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="admin.php"><i class="fa fa-circle-o"></i> Tambah Event</a></li>
  ...
  <div class="content-wrapper" style="min-height: 910px;">
    ...
    <section class="content-header">
      <h1>
        Input Event
        <small>Dimohon untuk memberikan hal yang bermanfaat untuk pembaca</small>
      </h1>
      <ol class="breadcrumb">
      ...
      <div class="box box-primary">
        <form action="tambah_event.php" method="post" enctype="multipart/form-data">
          <div class="box-header with-border">
            <input type="text" class="form-control" name="judul" placeholder="Nama Kegiatan" style="border-radius: 5px; margin-bottom: 10px;" required>
          </div>
          <div class="box-header with-border">
            <input type="text" class="form-control" name="tempat" placeholder="Tempat Kegiatan" style="border-radius: 5px;" required>
          </div>
          <!-- Date range -->
          <div class="form-group box-header with-border">
            ...
            <div class="input-group date">
              ...
              <input type="text" class="form-control pull-right" name="tanggal" id="datepicker"  style="border-radius: 0 5px 5px 0;" required="">
            </div>
            <!-- /.input group -->
          </div>
          <!-- /.date -->
      		<div class="form-group box-header with-border">
      			<input class="form-control" type="file" id="InputFile" name="file" style="border-radius: 5px;" required>
      		</div>
          <!-- /.box-body -->
          <textarea class="form-control texteditor" name="isiEvent" id="isiEvent" cols="30" rows="10" required></textarea>
          <!-- /.textarea-->
          <button type="submit" class="btn btn-primary" style="width: 120px; margin: 10px;">Kirim <i class="fa fa-send"></i></button>
        </form>
      </div>
      <!-- /.box -->
